...
GLOBALDEF int FtpSetRestartAt(const unsigned long long restartAt, netbuf *nControl);

GLOBALDEF int FtpRestartAt(unsigned long int restartAt, netbuf *nControl);
GLOBALDEF int FtpAbort(netbuf *nControl);
