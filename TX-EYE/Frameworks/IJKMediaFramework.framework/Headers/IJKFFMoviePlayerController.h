...
- (void)setVrMode:(BOOL)vrMode withStretch:(BOOL)stretched;
- (void)setRotation180:(BOOL)rotation180;
...
// skip frame
- (void)skipFrame:(int)num;
- (void)skipFrameInMS:(int64_t)ms;
- (void)stopSkipFrame;
// drop frames when recording
- (void)dropRecordFrame:(int)num;
// framerate
- (float)getDefineFramerate;
- (float)getOutputFramerate;
- (float)getDecodeFramerate;
- (void)setVideoForceFramerate:(float)framerate;
